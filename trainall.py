...
from modelall import GoogLeNet
...
def main():
    ...
    json_str = json.dumps(cla_dict, indent=9)   # 将cla_dict  编码成json 格式
    ...
    save_path = "./flower-all.pth"
    best_acc = 0.0
    epochs = 30

    writer = SummaryWriter('./weigths-flower-all')
